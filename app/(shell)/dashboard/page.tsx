      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {apps.map((app) => (
          <Link
            key={app.id}
            href={app.basePath}
            className="group relative flex flex-col gap-4 p-6 rounded-xl border border-border bg-card hover:bg-accent/50 hover:border-border/80 transition-all duration-150"
          >
